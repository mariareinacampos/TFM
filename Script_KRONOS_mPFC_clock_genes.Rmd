...
pd60_mpfc_bmal1 <- na.omit(pd60_mpfc_bmal1)
pd60_mpfc_bmal1$Cycle <- factor(pd60_mpfc_bmal1$Cycle) #Put "Cycle" as factor
...
pd60_mpfc_clock <- na.omit(pd60_mpfc_clock)
pd60_mpfc_clock$Cycle <- factor(pd60_mpfc_clock$Cycle) #Put "Cycle" as factor

pd60_mpfc_cry1 <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_cry1.xlsx")
pd60_mpfc_cry1 <- na.omit(pd60_mpfc_cry1)
pd60_mpfc_cry1$Cycle <- factor(pd60_mpfc_cry1$Cycle) #Put "Cycle" as factor

pd60_mpfc_cry2 <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_cry2.xlsx")
pd60_mpfc_cry2 <- na.omit(pd60_mpfc_cry2)
pd60_mpfc_cry2$Cycle <- factor(pd60_mpfc_cry2$Cycle) #Put "Cycle" as factor

pd60_mpfc_dbp <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_dbp.xlsx")
pd60_mpfc_dbp <- na.omit(pd60_mpfc_dbp)
pd60_mpfc_dbp$Cycle <- factor(pd60_mpfc_dbp$Cycle) #Put "Cycle" as factor
...
pd60_mpfc_gsk3b <- na.omit(pd60_mpfc_gsk3b)
pd60_mpfc_gsk3b$Cycle <- factor(pd60_mpfc_gsk3b$Cycle) #Put "Cycle" as factor
...
pd60_mpfc_nr1d2 <- na.omit(pd60_mpfc_nr1d2)
pd60_mpfc_nr1d2$Cycle <- factor(pd60_mpfc_nr1d2$Cycle) #Put "Cycle" as factor

pd60_mpfc_per1 <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_per1.xlsx")
pd60_mpfc_per1 <- na.omit(pd60_mpfc_per1)
pd60_mpfc_per1$Cycle <- factor(pd60_mpfc_per1$Cycle) #Put "Cycle" as factor

pd60_mpfc_per2 <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_per2.xlsx")
pd60_mpfc_per2 <- na.omit(pd60_mpfc_per2)
pd60_mpfc_per2$Cycle <- factor(pd60_mpfc_per2$Cycle) #Put "Cycle" as factor

pd60_mpfc_rora <- read_excel("/Users/mariareinacampos/Documents/00_MASTER/TFM/Resultats/Results_PD60_mPFC/pd60_mpfc_rora.xlsx")
pd60_mpfc_rora <- na.omit(pd60_mpfc_rora)
pd60_mpfc_rora$Cycle <- factor(pd60_mpfc_rora$Cycle) #Put "Cycle" as factor
...
levels(pd60_mpfc_rora$Cycle) #Posar un dels excels per veure si s'han posat com a factor
